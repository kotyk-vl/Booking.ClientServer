...
namespace lab2
{
    public partial class TicketsActual : Form
    {

        public TicketsActual()
        {
            InitializeComponent();
        }
        ...
        public void Connect(String server, String message)
        {
            ...
            try
            {
                ...
                if (Convert.ToInt32(N) != 9)
                {
                    ...
                    {
                        dataGridView1.Rows.Add(Звідки[i], Куди[i], Дата_Час[i], Номер_поїзда[i], Місце[i], Вагон[i], Прізвище[i], Імя[i]);
